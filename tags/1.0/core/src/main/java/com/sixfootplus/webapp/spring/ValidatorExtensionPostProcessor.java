package com.sixfootplus.webapp.spring;
 ...
 * 
 * <pre>
 * &lt;bean class=&quot;com.sixfootplus.webapp.spring.ValidatorExtensionPostProcessor&quot;&gt;
	...
	public void postProcessBeanFactory(
		...
		if (configurableListableBeanFactory
			...
			PropertyValue propertyValue = propertyValues
					.getPropertyValue("validationConfigLocations");

			// value is expected to be a list.
			List existingValidationConfigLocations = (List) propertyValue
					.getValue();
