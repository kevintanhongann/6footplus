 ...
 *         the word... aka... it uses Generics.
 * 
 *         Implementations of this class are not intended for subclassing. You
 *         most likely would want to subclass GenericDao. The only real
 ...
 *         GenericDao, hence you'll have to do some casting if you use this one.
 * 
 * @see com.sixfootplus.dao.GenericDao
 */
