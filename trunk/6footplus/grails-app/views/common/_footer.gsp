...
<p class="date" style="text-align: right">this blogging engine built entirely with groovy & grails | <a class="brown_s" href="http://code.google.com/p/6footplus/">source code</a></p>
