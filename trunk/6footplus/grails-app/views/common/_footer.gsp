<div id="footer">
    <div id="footer-left">
        ...
        <p class="textlight" style="padding: 7px;">herzlich willkommen! i&#39;m currently living and working in perth, western australia. i&#39;m a java, grails, groovy software developer and one might notice my site being a bit of a geek&#39;s sandpit. feel free to have a gander!</p>
        <p class="textlight" style="padding: 7px;">andreas nerlich<br />software developer<br />perth, western australia<br /><a class="brown" href="/sms"><u>sms</u></a> or <a class="brown" href="/contact"><u>contact</u></a> me<br/><br/><a class="brown" href="http://about.me/andreasnerlich">about.me/andreasnerlich</a></p>
    ...
    <div id="footer-right">    
        ...
        <div id="footer-right-middle">
            <div id="footer-right-middle-left">
                <tooltip:tip value="View a list of recently published videos">
                    <a href="/home/show/206" class="title">recent videos</a>
                </tooltip:tip>
            ...
            <div id="footer-right-middle-center">
                <tooltip:tip value="View all recently published photos">
                    <a href="http://photos.6footplus.com/recent.php" class="title">recent photos</a>
                </tooltip:tip>
            ...
            <div id="footer-right-middle-right">
                <tooltip:tip value="View more of my recent twitter images on twitpic.com">
                    <a href="http://twitpic.com/photos/6footplus" class="title">recent twitpics</a>
                </tooltip:tip>
        ...
        <div id="footer-right-bottom">
            <div id="footer-right-middle-right">
                ...
                <span id="padding-left-20">• <a href="http://photos.6footplus.com/recent.php">flickr photos</a></span><br/>
                <span id="padding-left-20">• <a href="http://www.flickr.com/photos/6footplus/map/">photo locations</a></span><br/>
                <span id="padding-left-20">• <a href="/pics/">archived photos</a></span><br/>
                <span id="padding-left-20">• <a href="/searchable">search site</a>&nbsp;<img src="/images/search.png" height="12"/></span>
            </div>
