<html>
    ...
    <body id="contact-page">
        ...
        <p><img style="border-style: solid; border-color: rgb(102, 102, 51);  margin-top: 0px; margin-left: 10px; float:right" border="1" src="http://www.gravatar.com/avatar/a255cd6bb89a855fa55baed5817fcce8.png"/>you can get a hold of me on my mobile phone +49 176 4815 7373 or +61 424 727 020, <g:link controller="sms">send me an sms</g:link>, email me at me&#64;6footplus.com or simply submit the simple form below.</p>
        <p>my CV (curriculum vitae) is available as a <a href="http://nerlich.it">download</a> in both Microsoft Word and PDF versions.</p>
